...
export default function OnboardingInitializer() {
  ...
  return (
    <div
      className="fixed inset-0 z-[100000] flex items-center justify-center bg-slate-950/55 p-4 backdrop-blur-sm select-none"
      role="dialog"
      aria-modal="true"
      aria-label="Hoàn tất tài khoản"
    >
      <div className="max-h-[92vh] w-full max-w-xl overflow-y-auto rounded-3xl border border-border bg-card p-5 shadow-2xl sm:p-7 animate-in fade-in-50 zoom-in-95 duration-150">
        ...
        {checkingPassword ? (
          ...
          <div className="rounded-2xl border border-destructive/30 bg-destructive/10 p-4 text-sm text-destructive">
            ...
            <button
              ...
              className="mt-3 rounded-xl bg-destructive px-4 py-2 text-xs font-bold text-destructive-foreground cursor-pointer"
            >
              Thử lại
            </button>
          </div>
